...
const KirmiziEtYemekleri= () => {
    return (
      ...
      <center>
        {" "}
        <h2 class={{ fontWeight: "bold" }} style={{ fontFamily: "  Broadway" }}>Kırmızı Et Yemekleri</h2>
      </center>
      <br></br>
      <br></br>
      <div class="ui four cards">
        <div class="card">
          ...
          <div class="extra">Hünkarbeğendi</div>
          <div class="extra">Fiyat : ₺ 17,45</div>
        </div>
        <div class="card">
          <div class="image">
            <img src={require("../images/isvec-kofte.jpg")} />
          </div>
          <div class="extra">
          Domates Soslu İsveç Köfte
        ...
        <div class="card">
          <div class="image">
            <img src={require("../images/begendi-yataginda-kofte.jpg")} />
          </div>
          <div class="extra">
        ...
        <div class="card">
          <div class="image">
            <img
              src={require("../images/izgara-kofte-ve-karisik-sebze.jpg")}
            />
          </div>
          <div class="extra">
        ...
        <div class="card">
          <div class="image">
            <img
              src={require("../images/orman-kebabi.jpg")}
            />
          </div>
          <div class="extra">
          Orman Kebabı
        ...
        <div class="card">
          ...
          <div class="extra">Fiyat : ₺ 21,95</div>
        </div>
